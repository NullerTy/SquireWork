const Page: React.FC = () => {
  const text =
    'LOREMLorem LOREMLorem LOREMLorem L? Ne non, quam debitis dolorum ea accusantium aspernatur, impedit obcaecati corporis'
    ...
    <>
      ...
      <div className='mb-20 mt-20 flex-wrap'>
        <h1 className='text-wrap text-center text-5xl font-medium [text-shadow:_1px_2px_3px_rgba(0,0,0,0.2);]'>
          <span className='text-7xl text-blue-600'>Yolo</span>{' '}
          <span className='text-3xl'>Yolo</span>{' '}
          <span className='text-7xl text-emerald-500'>Yolo</span>
        </h1>
      </div>
      {/* Line */}
